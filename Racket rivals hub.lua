...
PlayerTab:CreateToggle({
   Name = "Infinite Jump", Callback = function(v)
      if v then
...
PlayerTab:CreateToggle({
   Name = "No Clip", Callback = function(v)
...
PlayerTab:CreateToggle({
   Name = "God Mode", Callback = function(v)
...
MovementTab:CreateSlider({
   Name = "Walk Speed", Range = {16, 500}, Increment = 1, CurrentValue = 16,
   Callback = function(v)
...
MovementTab:CreateSlider({
   Name = "Jump Power", Range = {50, 500}, Increment = 1, CurrentValue = 50,
   Callback = function(v)
...
CombatTab:CreateToggle({
   Name = "Aimbot (Ball Lock)", Callback = function(v)
      local c
      if v then
         c = game:GetService("RunService").Heartbeat:Connect(function()
...
CombatTab:CreateButton({
   Name = "Auto Hit Ball", Callback = function()
...
VisualsTab:CreateToggle({
   Name = "Player ESP", Callback = function(v)
      local c
      if v then
         c = game:GetService("RunService").Heartbeat:Connect(function()
...
VisualsTab:CreateToggle({
   Name = "Fullbright", Callback = function(v)
...
Rayfield:Notify({ Title = "Loaded!", Content = "Key: XoX! | Enjoy!", Duration = 4 })
